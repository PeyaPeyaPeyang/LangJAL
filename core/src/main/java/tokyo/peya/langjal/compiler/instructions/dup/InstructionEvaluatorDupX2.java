...
public class InstructionEvaluatorDupX2 extends AbstractSingleInstructionEvaluator<JALParser.JvmInsDupX2Context> {
    ...
    public FrameDifferenceInfo getFrameDifferenceInfo(@NotNull InstructionInfo instruction) {
        ...
        StackElementCapsule topElement2 = new StackElementCapsule(instruction, true);
    ...
    @Override
    public JALParser.JvmInsDupX2Context map(JALParser.@NotNull InstructionContext instruction) {
