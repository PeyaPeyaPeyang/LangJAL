...
public class InstructionEvaluatorAStoreN extends AbstractInstructionEvaluator<JALParser.JvmInsAstoreNContext>
{
                                         ...
                                         JALParser.@NotNull JvmInsAstoreNContext instruction)
    {
        ...
        if (has(instruction.INSN_ASTORE_0()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ASTORE, 0, type, ins);
        else if (has(instruction.INSN_ASTORE_1()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ASTORE, 1, type, ins);
        else if (has(instruction.INSN_ASTORE_2()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ASTORE, 2, type, ins);
        else if (has(instruction.INSN_ASTORE_3()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ASTORE, 3, type, ins);
