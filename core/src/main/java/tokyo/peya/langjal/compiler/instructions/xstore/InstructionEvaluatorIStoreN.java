...
public class InstructionEvaluatorIStoreN extends AbstractInstructionEvaluator<JALParser.JvmInsIstoreNContext>
{
                                         ...
                                         JALParser.@NotNull JvmInsIstoreNContext instruction)
    {
        ...
        if (has(instruction.INSN_ISTORE_0()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ISTORE, 0, "I", ins);
        else if (has(instruction.INSN_ISTORE_1()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ISTORE, 1, "I", ins);
        else if (has(instruction.INSN_ISTORE_2()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ISTORE, 2, "I", ins);
        else if (has(instruction.INSN_ISTORE_3()))
            return InstructionEvaluateHelperXStore.evaluateN(context, labels, locals, this, EOpcodes.ISTORE, 3, "I", ins);
