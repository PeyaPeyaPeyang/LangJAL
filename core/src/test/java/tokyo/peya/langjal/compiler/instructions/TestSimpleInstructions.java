...
public class TestSimpleInstructions {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            ...
                            "bipush 127",
                            new org.objectweb.asm.tree.IntInsnNode(Opcodes.BIPUSH, 127)
                    ),
                    of(
                            create(object(TypeDescriptor.className("java/lang/String")))
                                    .expected(create(
                                            ...
                                            integerValue()
                                    )), "bipush 127", new org.objectweb.asm.tree.IntInsnNode(Opcodes.BIPUSH, 127)
                    ),
                    of(
                            create()
                                    .expected(create(integerValue())),
                            "bipush -128",
                            new org.objectweb.asm.tree.IntInsnNode(Opcodes.BIPUSH, -128)
                    )
            );
        }
    }
            ...
            return set(
                    of(
                            create()
                                    .expected(create(integerValue())),
                            "sipush 32767",
                            new org.objectweb.asm.tree.IntInsnNode(Opcodes.SIPUSH, 32767)
                    ),
                    of(
                            create(object(TypeDescriptor.className("java/lang/String")))
                                    .expected(create(
                                            object(TypeDescriptor.className("java/lang/String")),
                                            integerValue()
                                    )), "sipush 32767", new org.objectweb.asm.tree.IntInsnNode(Opcodes.SIPUSH, 32767)
                    ),
                    of(
                            create()
                                    .expected(create(integerValue())),
                            "sipush -32768",
                            new org.objectweb.asm.tree.IntInsnNode(Opcodes.SIPUSH, -32768)
                    )
            );
        }
    }
    ...
    class TestPop2 extends AbstractInstructionTestCase<JALParser.JvmInsPop2Context, InstructionEvaluatorPop2> {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    ...
                    of(
                            create(object(TypeDescriptor.className("java/lang/String")), integerValue(), integerValue())
                                    .expected(create(object(TypeDescriptor.className("java/lang/String")))),
                            "pop2",
                            Opcodes.POP2
                    )
    ...
    class TestArrayLength
            extends AbstractInstructionTestCase<JALParser.JvmInsArraylengthContext, InstructionEvaluatorArrayLength> {
        TestArrayLength() {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            create(object(TypeDescriptor.parse("[I")))
                                    .expected(create(integerValue())), "arraylength", Opcodes.ARRAYLENGTH
                    ),
                    of(
                            create(object(TypeDescriptor.parse("[Ljava/lang/String;")))
                                    .expected(create(integerValue())), "arraylength", Opcodes.ARRAYLENGTH
                    ),
                    of(
                            create(
                                    object(TypeDescriptor.className("java/lang/String")),
                                    object(TypeDescriptor.parse("[I"))
                            )
                                    .expected(create(
                                            object(TypeDescriptor.className("java/lang/String")),
                                            integerValue()
    ...
    class TestAThrow extends AbstractInstructionTestCase<JALParser.JvmInsAthrowContext, InstructionEvaluatorAThrow> {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            create(object(TypeDescriptor.className("java/lang/Throwable")))
                                    .expected(create()), "athrow", Opcodes.ATHROW
                    ),
                    of(
                            create(integerValue(), object(TypeDescriptor.className("java/lang/Throwable")))
    ...
    @Nested
    class TestMonitorEnter
            extends AbstractInstructionTestCase<JALParser.JvmInsMonitorenterContext, InstructionEvaluatorMonitorEnter> {
        TestMonitorEnter() {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    ...
                    of(
                            create(integerValue(), anyObject()).expected(create(integerValue())),
                            "monitorenter",
    ...
    class TestMonitorExit
            extends AbstractInstructionTestCase<JALParser.JvmInsMonitorexitContext, InstructionEvaluatorMonitorExit> {
        TestMonitorExit() {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            ...
                            new org.objectweb.asm.tree.TypeInsnNode(Opcodes.NEW, "java/lang/String")
                    ),
                    of(
                            create(integerValue())
                                    .expected(create(
    ...
    @Nested
    class TestANewArray
            extends AbstractInstructionTestCase<JALParser.JvmInsAnewArrayContext, InstructionEvaluatorANewArray> {
        TestANewArray() {
    ...
    @Nested
    class TestNewArray
            extends AbstractInstructionTestCase<JALParser.JvmInsNewarrayContext, InstructionEvaluatorNewArray> {
        TestNewArray() {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            create(integerValue())
                                    .expected(create(object(TypeDescriptor.parse("[I")))),
                            "newarray I",
                            new org.objectweb.asm.tree.IntInsnNode(Opcodes.NEWARRAY, Opcodes.T_INT)
                    ),
                    of(
                            create(object(TypeDescriptor.className("java/lang/String")), integerValue())
                                    .expected(create(
    ...
    @Nested
    class TestMultiANewArray
            extends AbstractInstructionTestCase<JALParser.JvmInsMultianewarrayContext, InstructionEvaluatorMultiANewArray> {
        TestMultiANewArray() {
    ...
    @Nested
    class TestCheckCast
            extends AbstractInstructionTestCase<JALParser.JvmInsCheckcastContext, InstructionEvaluatorCheckCast> {
        TestCheckCast() {
    ...
    class TestInstanceOf
            extends AbstractInstructionTestCase<JALParser.JvmInsInstanceofContext, InstructionEvaluatorInstanceOf> {
        TestInstanceOf() {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            ...
                            new org.objectweb.asm.tree.TypeInsnNode(Opcodes.INSTANCEOF, "java/lang/String")
                    ),
                    of(
                            create(object(TypeDescriptor.className("java/lang/Object")), anyObject())
                                    .expected(create(
