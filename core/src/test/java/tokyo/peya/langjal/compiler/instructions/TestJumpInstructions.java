...
public class TestJumpInstructions
{
    ...
    class TestGotoCase extends LabelJumpTestCase<JALParser.JvmInsGotoContext, InstructionEvaluatorGoto>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsGotoContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
    ...
    class TestGotoWCase extends LabelJumpTestCase<JALParser.JvmInsGotoWContext, InstructionEvaluatorGotoW>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsGotoWContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestJsrCase extends LabelJumpSameTestCase<JALParser.JvmInsJsrContext, InstructionEvaluatorJsr>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsJsrContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestJsrWCase extends LabelJumpSameTestCase<JALParser.JvmInsJsrWContext, InstructionEvaluatorJsrW>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsJsrWContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestIfOPCase extends LabelJumpTestCase<JALParser.JvmInsIfOPContext, InstructionEvaluatorIfOP>
    {
        TestIfOPCase()
        {
            super(new InstructionEvaluatorIfOP(), EOpcodes.IFEQ, EOpcodes.IFNE, EOpcodes.IFLT, EOpcodes.IFGE, EOpcodes.IFGT, EOpcodes.IFLE);
        }

        @Override
        protected void prepareContext(JALParser.JvmInsIfOPContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestIfICmpOPCase extends LabelJumpTestCase<JALParser.JvmInsIfIcmpOPContext, InstructionEvaluatorIfICmpOP>
    {
        TestIfICmpOPCase()
        {
            super(new InstructionEvaluatorIfICmpOP(), EOpcodes.IF_ICMPEQ, EOpcodes.IF_ICMPNE, EOpcodes.IF_ICMPLT, EOpcodes.IF_ICMPGE, EOpcodes.IF_ICMPGT, EOpcodes.IF_ICMPLE);
        }

        @Override
        protected void prepareContext(JALParser.JvmInsIfIcmpOPContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestIfACmpOPCase extends LabelJumpTestCase<JALParser.JvmInsIfAcmpOPContext, InstructionEvaluatorIfACmpOP>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsIfAcmpOPContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestIfNullCase extends LabelJumpTestCase<JALParser.JvmInsIfNullContext, InstructionEvaluatorIfNull>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsIfNullContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
    ...
    class TestIfNonNullCase extends LabelJumpTestCase<JALParser.JvmInsIfNonnullContext, InstructionEvaluatorIfNonNull>
    {
        ...
        @Override
        protected void prepareContext(JALParser.JvmInsIfNonnullContext instruction, org.objectweb.asm.tree.ClassNode ownerClass, org.objectweb.asm.tree.MethodNode ownerMethod, InstructionsHolder instructions, LabelsHolder labels, LocalVariablesHolder locals)
        {
            labels.register(instruction.labelName(), 0);
        }
