...
public class TestXLoad {
    ...
    private abstract class XLoadTestCase<T extends ParserRuleContext, E extends AbstractInstructionEvaluator<T>>
        ...
        protected InstructionCase localLoadWithState(int index, StackMachine.StackValue value, String syntax,
                                                     int opcode) {
            return of(
                    create(integerValue()).set(index, value)
                            .set(10, object(TypeDescriptor.className("java/lang/String")))
                            .expected(create(integerValue(), value).set(index, value)
                                    .set(
                                            10,
                                            object(TypeDescriptor.className(
                                                    "java/lang/String"))
                                    )),
                    syntax,
                    new VarInsnNode(opcode, index)
