...
class InstructionsHolderTest {
    ...
    void addInstructionUsesEvaluatedInstructionSizeAndSourceLine() {
        ...
        EvaluatedInstruction evaluated = EvaluatedInstruction.of(
                evaluator(EOpcodes.NOP),
                new InsnNode(EOpcodes.NOP),
                7
        );
    ...
    void importInstructionRejectsNodesWithoutOpcode() {
        ...
        assertThrows(
                ...
                () -> holder.importInstruction(new LabelNode(new Label()), null, 1)
        );
    }
