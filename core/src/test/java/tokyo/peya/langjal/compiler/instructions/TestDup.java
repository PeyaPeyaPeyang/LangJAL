...
public class TestDup {
    ...
    class TestDupX1Case extends AbstractInstructionTestCase<JALParser.JvmInsDupX1Context, InstructionEvaluatorDupX1> {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            create(integerValue(), floatValue())
                                    .expected(create(floatValue(), integerValue(), floatValue())),
                            "dup_x1",
                            EOpcodes.DUP_X1
                    ),
                    of(
                            create(object(TypeDescriptor.className("java/lang/String")), integerValue(), floatValue())
                                    .expected(create(
                                            object(TypeDescriptor.className("java/lang/String")),
                                            floatValue(),
                                            integerValue(),
                                            floatValue()
                                    )), "dup_x1", EOpcodes.DUP_X1
                    )
            );
        }
    }
    ...
    class TestDup2Case extends AbstractInstructionTestCase<JALParser.JvmInsDup2Context, InstructionEvaluatorDup2> {
        ...
        public InstructionCase[] getValidInstructionSyntaxes() {
            return set(
                    of(
                            create(integerValue(), floatValue())
                                    .expected(create(integerValue(), floatValue(), integerValue(), floatValue())),
                            "dup2",
                            EOpcodes.DUP2
                    ),
                    of(
                    ...
                    of(
                            create(
                                    ...
                                    .expected(create(
                                            ...
                                            integerValue(),
                                            floatValue()
                                    )), "dup2_x2", EOpcodes.DUP2_X2
                    ),
                    of(
                            create(
                                    object(TypeDescriptor.className("java/lang/Throwable")),
                                    object(TypeDescriptor.className("java/lang/Object")),
                                    object(TypeDescriptor.className("java/lang/String")),
                                    integerValue(),
                                    floatValue()
